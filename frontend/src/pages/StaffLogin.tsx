  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(oklch(0.7 0.15 220 / 0.03) 1px, transparent 1px),
            linear-gradient(90deg, oklch(0.7 0.15 220 / 0.03) 1px, transparent 1px)
          `,
      ...
      <div className="w-full max-w-md relative">
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 40px oklch(0.7 0.15 220 / 0.1), 0 20px 60px oklch(0 0 0 / 0.5)',
          }}
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-mono font-semibold mb-2" style={{ color: 'oklch(0.6 0.1 220)' }}>
                USUÁRIO
              </label>
              <input
                type="text"
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background: stayLoggedIn ? 'oklch(0.7 0.15 220)' : 'transparent',
                  border: `1px solid ${stayLoggedIn ? 'oklch(0.7 0.15 220)' : 'oklch(0.7 0.15 220 / 0.4)'}`,
                  boxShadow: stayLoggedIn ? '0 0 8px oklch(0.7 0.15 220 / 0.4)' : 'none',
                }}
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 0 20px oklch(0.7 0.15 220 / 0.4)',
              }}
            >
              {loading ? (
