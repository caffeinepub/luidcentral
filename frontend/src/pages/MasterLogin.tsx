...
import { validateAdminLogin } from '../lib/db';
...
export default function MasterLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const admin = validateAdminLogin(username.trim(), password);
    if (admin) {
      login(
        { id: admin.username, userType: 'admin', displayName: admin.username },
        stayLoggedIn
      );
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `
            linear-gradient(oklch(0.75 0.18 80 / 0.03) 1px, transparent 1px),
            linear-gradient(90deg, oklch(0.75 0.18 80 / 0.03) 1px, transparent 1px)
          `,
      ...
      <div className="w-full max-w-md relative">
        <div
          ...
          style={{
            ...
            border: '1px solid oklch(0.75 0.18 80 / 0.35)',
            boxShadow: '0 0 40px oklch(0.75 0.18 80 / 0.1), 0 20px 60px oklch(0 0 0 / 0.5)',
          }}
        >
          <div className="text-center mb-8">
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 15px oklch(0.75 0.18 80 / 0.2)',
              }}
            >
              <Shield className="w-8 h-8" style={{ color: 'oklch(0.75 0.18 80)' }} />
            </div>
            <h1
              className="text-2xl font-bold tracking-widest font-mono"
              style={{ color: 'oklch(0.75 0.18 80)', textShadow: '0 0 15px oklch(0.75 0.18 80 / 0.4)' }}
            >
              MASTER
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-mono font-semibold mb-2" style={{ color: 'oklch(0.65 0.1 80)' }}>
                USUÁRIO
              </label>
              <input
                type="text"
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background: stayLoggedIn ? 'oklch(0.75 0.18 80)' : 'transparent',
                  border: `1px solid ${stayLoggedIn ? 'oklch(0.75 0.18 80)' : 'oklch(0.75 0.18 80 / 0.4)'}`,
                  boxShadow: stayLoggedIn ? '0 0 8px oklch(0.75 0.18 80 / 0.4)' : 'none',
                }}
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 0 20px oklch(0.75 0.18 80 / 0.4)',
              }}
            >
              {loading ? (
